...
def test_flow():
    ...
    alloc_data = make_request('POST', f'/projects/{proj_id}/allocations/', params={
    ...
    print("Allocation table structure correct: selling_hourly_rate is present in allocation object")
